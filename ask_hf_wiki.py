...
from langchain.llms import HuggingFaceModel  # Change to HuggingFaceModel
...
class Genie:
    ...
    def __init__(self, file_path: str):
        ...
        self.genie = RetrievalQA.from_chain_type(llm=HuggingFaceModel(), chain_type="stuff", retriever=self.vectordb.as_retriever())
...
if __name__ == "__main__":
    genie = Genie("2023-10-09 10:10:37.435956.txt")
